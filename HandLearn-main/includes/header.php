...
// Toast da una redirect (?msg=success|info|...)
$flashType = $_GET['msg']  ?? '';
$flashText = $_GET['text'] ?? '';
?>
<!DOCTYPE html>
...
<meta name="description" content="HandLearn - piattaforma didattica interattiva per imparare la Lingua dei Segni Italiana con AI, lezioni e giochi.">
...
<script>
    setTimeout(() => {
        ...
        if (f) f.style.transition = 'opacity .4s'; if (f) f.style.opacity = 0;
